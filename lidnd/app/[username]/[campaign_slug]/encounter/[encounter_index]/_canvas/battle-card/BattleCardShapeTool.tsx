import { BaseBoxShapeTool, type TLClickEvent } from "tldraw";

export class BattleCardShapeTool extends BaseBoxShapeTool {
  static override id = "battle-card";
  static override initial = "idle";
  override shapeType = "battle-card";
